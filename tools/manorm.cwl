...
s:about: |
  usage: manorm [-h] [-v] --p1 FILE --p2 FILE [--pf FORMAT] --r1 FILE --r2 FILE
                ...
                [-w LENGTH] [--summit-dis LENGTH] [--n-random N] [-m FLOAT]
                [-p FLOAT] [--wa] [-o DIR] [--verbose]
  ...
  Input Arguments:
    ...
    --pf FORMAT, --peak-format FORMAT
                          Format of peak files. Supported: ['bed', 'bed-summit',
                          'macs', 'macs2', 'narrowpeak', 'broadpeak']. Default:
                          bed
    --r1 FILE, --read1 FILE
    ...
    --rf FORMAT, --read-format FORMAT
                          Format of read files. Supported: ['bed', 'bedpe',
                          'sam', 'bam']. Default: bed
    --n1 NAME, --name1 NAME
                          Name of sample 1, which is used in output files. If
                          not specified, the name of the peak file will be used
                          as the sample name.
    --n2 NAME, --name2 NAME
                          Name of sample 2, same as '--n1/--name1'.

  Reads Manipulation:
    --s1 N, --shiftsize1 N
                          Reads shift size of sample 1. Shift single-end reads
                          by N bp towards 3' direction and the 5' end of each
                          shifted read is used to represent the genomic locus of
                          underlying DNA fragment. Set to half of DNA fragment
                          size of the ChIP-seq library. Default: 100
    --s2 N, --shiftsize2 N
                          Reads shift size of sample 2, same as '--
                          s1/--shiftsize1'. Default: 100
    --pe, --paired-end    Paired-end mode. The middle point of each read pair is
                          used to represent the genomic locus of underlying DNA
                          fragment. '--s1' and '--s2' are ignored with this
                          option on.

  Normalization Model:
    -w LENGTH, --window-size LENGTH
                          Window size to count reads and calculate read
                          densities. 2000 is recommended for sharp histone marks
                          like H3K4me3 and H3K27ac, and 1000 for TFs or DNase-
                          seq. Default: 2000
    --summit-dis LENGTH   Overlapping common peaks with summit-to-summit
                          distance beyond this are excluded in model fitting.
                          Default: '-w/--window-size' / 4
    --n-random N          Number of random simulations to test the enrichment of
                          peak overlap between two samples. Set to 0 to disable
                          the testing. Default: 10

  Output Arguments:
    -m FLOAT, --m-cutoff FLOAT
                          Absolute M-value (log2-ratio) cutoff to define biased
